...
class WalletControllerTest {
    ...
    @Test
    @DisplayName("GET /wallets/me - Debería retornar 200 OK y la billetera del usuario autenticado")
    ...
    @Test
    @DisplayName("POST /wallets/me/deposit - Debería retornar 200 OK al depositar siendo dueño")
    void shouldAddFundsWhenOwner() throws Exception {
        ...
        mockMvc.perform(post("/wallets/me/deposit")
                        .header("X-User-Id", "10")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isOk());
